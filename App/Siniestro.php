        ...
        <div class="contenedor">
            <main>
                <nav>
                    ...
                    <a href="#" class="banner" data-pushbar-target="pushbar-productos">Inicio</a>
                </nav>
                <section class="productos">
                    <figure>
                        <img src="../Imagenes/img1.jpg" alt="">
                        <figcaption>
                            <a href="Siniestro/Materiales.php" >
                    ...
                    <figure>
                        ...
                        <figcaption>
                            <a href="Siniestro/Siniestro.php" >
                                <span>Siniestro</span>
                                <span>Ir</span>
                            </a>
                        </figcaption>
            ...
            <div data-pushbar-id="pushbar-menu" class="pushbar from_left pushbar-menu">
                ...
                <nav class="menu">
                    ...
                    <a href="Siniestro/Siniestro.php">Siniestro</a>
                    <a href="Siniestro/Mecanico.php">Mecanico</a>
                    <a href="Siniestro/Materiales.php">Materiales</a>
                </nav>
            </div>
        </div>
